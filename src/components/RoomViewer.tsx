    ...
    <div className="w-full max-w-6xl mx-auto py-1 px-6">
      ...
      {peerList.length === 0 ? (
        <div className="flex flex-col items-center justify-center mt-32 text-center">
          <div className="w-16 h-16 rounded-full border-2 border-dashed border-white/20 animate-[spin_4s_linear_infinite] flex items-center justify-center mb-6 relative">
            <div className="w-2 h-2 bg-neon-blue rounded-full absolute top-1" />
          </div>
          <h2 className="text-2xl font-semibold text-white mb-2">Scanning Network...</h2>
          <p className="text-white/40 max-w-md">
            Open FLUX on another device connected to the same Wi-Fi.
          </p>
        </div>
      ) : (
