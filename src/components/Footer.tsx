        ...
        <div className="flex items-center gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="p-2 rounded-lg bg-white/5 border border-white/10 text-white/40 hover:text-cyan-400 hover:border-cyan-400/50 hover:bg-cyan-400/5 transition-all duration-300 group"
            >
              <div className="group-hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
                {link.icon}
              </div>
            </a>
          ))}
